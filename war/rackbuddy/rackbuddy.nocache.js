...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "rackbuddy" because\n';
  ...
  $wnd.__gwt_activeModules['rackbuddy'] = {
    'moduleName' : 'rackbuddy',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/rackbuddy.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['rackbuddy'].superdevmode = true;

  var expectedSuffix = '/rackbuddy.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + rackbuddy + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:rackbuddy';
  var devModeSessionKey = '__gwtDevModeSession:rackbuddy';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':62481';
  ...
  $wnd.__gwt_activeModules['rackbuddy'].canRedirect = true;
  $wnd.__gwt_activeModules['rackbuddy'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/rackbuddy?user.agent=' + ua + '&_callback=' + callback;
